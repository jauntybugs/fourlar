...
const LeadMagnet: React.FC = () => {
  ...
  const handleRequestReview = async () => {
    ...
    try {
      const response = await fetch('https://formspree.io/f/fourlar@icloud.com', {
        method: 'POST',
      ...
      <div className="max-w-3xl mx-auto px-4">
        <div className="bg-white rounded-3xl shadow-xl overflow-hidden border border-slate-200">
              ...
              <div className="bg-slate-900 rounded-2xl p-8 text-white">
                ...
                <div className="flex flex-col sm:flex-row gap-4">
                  <input 
                    ...
                    className="flex-1 p-4 rounded-xl text-slate-900 outline-none focus:ring-2 focus:ring-blue-500" 
                  />
                  <button 
          ...
          <div className="bg-slate-50 p-6 border-t border-slate-100 text-center">
            <p className="text-xs text-slate-400 uppercase tracking-widest font-bold">FourLar Consulting Ltd &copy; 2024</p>
          </div>
        </div>
      </div>
    </div>
